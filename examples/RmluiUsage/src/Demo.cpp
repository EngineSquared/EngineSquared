    ...
    bool Initialize(Engine::Core &core, Rml::ElementDocument &doc)
    {
                ...
                rmlui_dynamic_cast<Rml::ElementFormControl *>(document->GetElementById("sandbox_rml_source")))
        {
            ...
            rmlValue += "<p>Write your RML here</p>\n\n<!-- <img "
                        "src=\"examples/RmluiUsage/asset/high_scores_alien_1.tga\"/> -->";
        ...
        if (auto *target = document->GetElementById("sandbox_target"))
        {
            ...
            Rml::FileHandle handle = fileInterface->Open("examples/RmluiUsage/asset/rml.rcss");
            if (handle != 0U)
            {
...
void Setup(Engine::Core &core)
{
    ...
    rmluiContext.LoadDocument("examples/RmluiUsage/asset/demo.rml");
