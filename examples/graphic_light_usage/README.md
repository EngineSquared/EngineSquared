...
1. Remove `includes("../../xmake.lua")` from `examples/graphic_light_usage/xmake.lua`
...
3. Add the following option inside xmake settings: `--with_graphic_light_usage_example=y`

4. Switch the mode to force the update of the setup. (debug to release or release to debug)

5. You should now see `GraphicLightUsage` target to compile, run, debug, etc.
