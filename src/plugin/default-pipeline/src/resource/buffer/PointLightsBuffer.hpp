...
class PointLightsBuffer : public Graphic::Resource::AGPUBuffer {
  private:
  ...
  public:
    ...
    ~PointLightsBuffer() override { Destroy(); }
    ...
    void Update(Engine::Core &core) override
    {
        ...
        if (skippedCount > 0)
        {
            Log::Warning(fmt::format("Maximum number of point lights ({}) reached. {} light(s) skipped.",
