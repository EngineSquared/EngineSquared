 ...
 * @brief GLTextBufferManager class declaration using Object::Resource::ResourceManager.
 *
...
using GLTextBufferManager = Object::Resource::ResourceManager<Utils::GLTextBuffer>;
