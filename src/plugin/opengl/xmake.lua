...
target("PluginOpenGL")
    ...
    add_includedirs("src/utils/MaterialData/", {public = true})
    ...
    add_includedirs("src/component/Shader/", {public = true})
    add_includedirs("src/component/Material/", {public = true})
    add_includedirs("src/component/Mesh/", {public = true})
