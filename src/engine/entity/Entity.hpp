...
class Entity {
  ...
  public:
     ...
     */
    template <typename TComponent> inline TComponent &AddComponent(Registry &registry, TComponent &&component);
     ...
     * @return  entity id
     */
    inline static Entity CreateNullEntity() { return Entity(entt::entity(entt::null)); }
