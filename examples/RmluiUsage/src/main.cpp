...
void ApplyOverlayState(Engine::Core &core)
{
    ...
    if (state.demoDirty)
    {
        ...
        if (state.demo)
            ui.LoadOverlayDocument("examples/RmluiUsage/asset/demo.rml");
        else
            ui.UnloadOverlayDocument("examples/RmluiUsage/asset/demo.rml");
    }
    if (state.animationDirty)
    {
        state.animationDirty = false;
        if (state.animation)
            ui.LoadOverlayDocument("examples/RmluiUsage/asset/animation.rml");
        else
            ui.UnloadOverlayDocument("examples/RmluiUsage/asset/animation.rml");
    ...
    if (state.transformDirty)
    {
        ...
        if (state.transform)
            ui.LoadOverlayDocument("examples/RmluiUsage/asset/transform.rml");
        else
            ui.UnloadOverlayDocument("examples/RmluiUsage/asset/transform.rml");
    }
...
void Setup(Engine::Core &core)
{
    ...
    rmluiContext.SetFont("examples/RmluiUsage/asset/LatoLatin-Regular.ttf");
    rmluiContext.SetFont("examples/RmluiUsage/asset/LatoLatin-Bold.ttf");
    rmluiContext.SetFont("examples/RmluiUsage/asset/LatoLatin-Italic.ttf");
    rmluiContext.SetFont("examples/RmluiUsage/asset/LatoLatin-BoldItalic.ttf");
    rmluiContext.SetFont("examples/RmluiUsage/asset/NotoEmoji-Regular.ttf");
    rmluiContext.EnableDebugger(true);
    rmluiContext.LoadDocument("examples/RmluiUsage/asset/hover_overlay.rml");

    auto &overlayState = core.RegisterResource<OverlayState>(OverlayState{});
    rmluiContext.LoadOverlayDocument("examples/RmluiUsage/asset/demo.rml");
