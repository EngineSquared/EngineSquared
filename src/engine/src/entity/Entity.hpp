...
class Entity {
  ...
  public:
    ...
    {
        ES::Utils::Log::Debug(fmt::format("[EntityID:{}] Destroy Entity", ES::Utils::Log::EntityToDebugString(_entity)));
    ...
    {
        ES::Utils::Log::Debug(fmt::format("[EntityID:{}] AddComponent: {}", ES::Utils::Log::EntityToDebugString(_entity),
