...
namespace Example {
class VehicleCreationPlugin : public Engine::APlugin {
  public:
    explicit VehicleCreationPlugin(Engine::Core &core) : Engine::APlugin(core) {}
    ~VehicleCreationPlugin() = default;
    void Bind() final
    {
...
{
    Engine::Core core;
    core.AddPlugins<Example::VehicleCreationPlugin>();
    core.RunSystems();
}
