...
using System = ES::Utils::FunctionContainer::CallableFunction<TCallable, void, Core &>;
...
class SystemContainer: public ES::Utils::FunctionContainer::FunctionContainer<void, Core &> {
  public:
    template <typename... TSystem> inline void AddSystems(TSystem... systems)
    {
        AddFunctions(systems...);
    }

    inline std::list<std::unique_ptr<SystemBase>> &GetSystems()
    {
