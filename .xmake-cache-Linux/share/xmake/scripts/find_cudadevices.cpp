...
inline void print_value(unsigned long long value) { printf("%llu", value); }

inline void print_value(unsigned long value) { printf("%lu", value); }

inline void print_value(unsigned int value) { printf("%u", value); }

inline void print_value(bool value) { printf(value ? "true" : "false"); }

inline void print_value(int value) { printf("%d", value); }

template <typename T, size_t len> inline void print_value(const T (&value)[len])
{
    printf("(");
...
inline void print_value(const void *value) { printf("\"%s\"", (const char *) value); }

template <size_t len> inline void print_value(const char (&value)[len])
{
    printf("\"");
...
template <> inline void print_value<16>(const char (&value)[16])
{
...
#if MY_CUDA_VER >= 1000
inline void print_value(const cudaUUID_t &value) { print_value(value.bytes); }
#endif

template <typename T> inline void print_property(const char *name, const T &value)
{
