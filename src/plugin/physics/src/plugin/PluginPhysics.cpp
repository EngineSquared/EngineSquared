...
{
    RegisterSystems<ES::Engine::Scheduler::Startup>([](const ES::Engine::Core &) { JPH::RegisterDefaultAllocator(); });
    RegisterSystems<ES::Engine::Scheduler::Startup>(
        [](const ES::Engine::Core &) { JPH::Factory::sInstance = new JPH::Factory(); });
    RegisterSystems<ES::Engine::Scheduler::Startup>([](const ES::Engine::Core &) { JPH::RegisterTypes(); });
    ...
    RegisterSystems<ES::Engine::Scheduler::Startup>(
        ES::Plugin::Physics::System::OnConstructLinkRigidBodieToPhysicsSystem);
    ...
    RegisterSystems<ES::Engine::Scheduler::Shutdown>([](const ES::Engine::Core &) { JPH::UnregisterTypes(); });
