...
void ES::Plugin::Input::Resource::InputManager::KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
...
void ES::Plugin::Input::Resource::InputManager::MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
    if (action == GLFW_PRESS) {
