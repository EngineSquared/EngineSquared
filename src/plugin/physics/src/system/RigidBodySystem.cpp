...
{
    // Priority 1: SphereCollider (most efficient shape)
    ...
    // Priority 2: CapsuleCollider (efficient for characters)
    ...
    // Priority 4: DefaultCollider (fallback box)
