...
TEST(PhysicsPlugin, CubeFallingOnPlane)
{
    ...
    Engine::Entity plane = core.CreateEntity();
    {
        Object::Component::Transform transform;
        transform.SetPosition(0.0f, 0.0f, 0.0f);
        plane.AddComponent<Object::Component::Transform>(core, transform);
        ...
        plane.AddComponent<Physics::Component::RigidBody>(core, rigidBody);

        Physics::Component::BoxCollider collider;
        collider.halfExtents = glm::vec3(50.0f, 1.0f, 50.0f);
        plane.AddComponent<Physics::Component::BoxCollider>(core, collider);
    }
    ...
    float startY = 10.0f;
    {
        ...
        cube.AddComponent<Physics::Component::BoxCollider>(core, collider);
    }
    ...
    const auto &cubeTransform = cube.GetComponents<Object::Component::Transform>(core);
